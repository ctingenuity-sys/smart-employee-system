...
'nav.rotation':{ar:'تدوير الجدول',en:'rotation'},
  ...
  // --- Cath-Lab Usage ---
  'cath.titleForm': { ar: 'تسجيل مستلزمات القسطرة', en: 'Record Cath-Lab Supplies' },
  'cath.titleManage': { ar: 'إدارة مستلزمات القسطرة', en: 'Manage Cath-Lab Supplies' },
  'cath.tabForm': { ar: 'تسجيل استخدام', en: 'Record Usage' },
  'cath.tabReport': { ar: 'تقرير الاستخدام (الطباعة)', en: 'Usage Report (Print)' },
  'cath.tabManage': { ar: 'إدارة المستلزمات', en: 'Manage Supplies' },
  
  'cath.fileId': { ar: 'رقم الملف', en: 'Patient File No' },
  ...
  'cath.balloonNone': { ar: 'بدون بالون / اختر البالون', en: 'No Balloon / Select Balloon' },
  'cath.save': { ar: 'حفظ البيانات', en: 'Save Data' },
  'cath.by': { ar: 'بواسطة', en: 'By' },
  
  'cath.manageName': { ar: 'الاسم', en: 'Name' },
  'cath.manageEx': { ar: 'مثال: Synergy xD stent / د. أحمد', en: 'Example: Synergy or Dr. Ahmed' },
  'cath.manageType': { ar: 'النوع', en: 'Type' },
  'cath.typeStent': { ar: 'الدعامة (Stent)', en: 'Stent' },
  'cath.typeBalloon': { ar: 'البالون (Balloon)', en: 'Balloon' },
  'cath.typeDcb': { ar: 'بالون مغلف بالدواء (DCB)', en: 'Drug Coated Balloon (DCB)' },
  'cath.typeOther': { ar: 'مستلزمات أخرى (Other Supplies)', en: 'Other Supplies' },
  'cath.typeDoctor': { ar: 'طبيب (Doctor)', en: 'Doctor' },
  'cath.typeProcedure': { ar: 'فحص (Procedure)', en: 'Procedure' },
  'cath.count': { ar: 'العدد', en: 'Count' },
  'cath.size': { ar: 'الحجم', en: 'Size' },
  'cath.sizeEx': { ar: 'مثال: 3x15', en: 'e.g. 3x15' },
  'cath.addStent': { ar: 'إضافة دعامة أخرى', en: 'Add Stent' },
  'cath.addBalloon': { ar: 'إضافة بالون آخر', en: 'Add Balloon' },
  'cath.addDcb': { ar: 'إضافة بالون DCB آخر', en: 'Add DCB Balloon' },
  'cath.dcbPlaceholder': { ar: 'بدون / اختر DCB', en: 'No DCB / Select DCB' },
  'cath.noDcbsAvailable': { ar: 'لم يتم إضافة بالونات DCB بعد. يمكنك إضافتها من تبويب إدارة المستلزمات.', en: 'No DCB balloons added yet. You can add them from the Supplies Management tab.' },
  'cath.noOthersAvailable': { ar: 'لم يتم إضافة مستلزمات أخرى بعد. يمكنك إضافتها من تبويب إدارة المستلزمات.', en: 'No other supplies added yet. You can add them from the Supplies Management tab.' },
  'cath.repModeRecords': { ar: 'سجلات المرضى', en: 'Patient Records' },
  'cath.repModeSummary': { ar: 'ملخص المستلزمات', en: 'Supplies Summary' },
  'cath.summaryType': { ar: 'القطاع', en: 'Category' },
  'cath.summaryName': { ar: 'الاسم', en: 'Name' },
  'cath.summarySize': { ar: 'الحجم', en: 'Size' },
  'cath.summaryCount': { ar: 'الكمية المستخدمة', en: 'Quantity Used' },
  'cath.add': { ar: 'إضافة', en: 'Add' },
  'cath.listStents': { ar: 'الدعامات (Stents)', en: 'Stents' },
  'cath.listBalloons': { ar: 'البالونات (Balloons)', en: 'Balloons' },
  'cath.listDcbs': { ar: 'بالونات (DCB)', en: 'DCB Balloons' },
  'cath.listOthers': { ar: 'مستلزمات أخرى (Other)', en: 'Other Supplies' },
  'cath.listDoctors': { ar: 'الأطباء (Doctors)', en: 'Doctors' },
  'cath.listProcedures': { ar: 'الفحوصات (Procedures)', en: 'Procedures' },
  'cath.doctorNone': { ar: 'اختر الطبيب', en: 'Select Doctor' },
  'cath.procedureOther': { ar: 'أخرى (كتابة يدوية)...', en: 'Other (type manually)...' },
  'cath.procedurePlaceholder': { ar: 'اكتب اسم الفحص...', en: 'Type procedure name...' },
  'cath.toggleManual': { ar: 'كتابة يدوية', en: 'Manual Entry' },
  'cath.toggleSelect': { ar: 'اختر من القائمة', en: 'Select from List' },
  'cath.customStentPlaceholder': { ar: 'اكتب اسم الدعامة...', en: 'Type stent name...' },
  'cath.customBalloonPlaceholder': { ar: 'اكتب اسم البالون...', en: 'Type balloon name...' },
  ...
  'cath.msgAdded': { ar: 'تم إضافة المستلزم', en: 'Supply added successfully' },
  'cath.msgDeleted': { ar: 'تم الحذف', en: 'Deleted successfully' },
  'cath.msgErr': { ar: 'حدث خطأ', en: 'An error occurred' },
  'cath.msgReq': { ar: 'يرجى إكمال البيانات المطلوبة', en: 'Please complete all required fields' },
  'cath.msgSaved': { ar: 'تم الحفظ بنجاح', en: 'Saved successfully' },
  'cath.msgSaveErr': { ar: 'حدث خطأ أثناء الحفظ', en: 'Error saving data' },
  'cath.confirmDel': { ar: 'هل أنت متأكد من الحذف؟', en: 'Are you sure you want to delete?' },
  ...
  'notif.schedule.msg|mode:published|month:2026-04': { ar: 'تم نشر جدول شهر أبريل ٢٠٢٦', en: 'April 2026 schedule has been published' },
...
'appt.toast.addSuccess': { 
  ...
  'sup.tab.fms': { ar: 'إدارة المرافق والسلامة', en: 'Facility & Safety Management' },
  'sup.tab.logbooks': { ar: 'سجلات الأقسام', en: 'Department Logbooks' },
  'sup.tab.rotations': { ar: 'التدوير', en: 'Rotations' },
  'sup.tab.panicReports': { ar: 'تقارير الطوارئ', en: 'Panic Reports' },
  'sup.tab.performance': { ar: 'الأداء', en: 'Performance' },
  'sup.tab.archiver': { ar: 'أرشفة البيانات', en: 'Data Archiver' },

  'sup.user.add': { ar: 'إضافة موظف جديد', en: 'Add New Employee' },
  'sup.user.addSuccess': { ar: 'تم إضافة الموظف بنجاح!', en: 'User Added Successfully!' },
  'sup.user.updateSuccess': { ar: 'تم تحديث الموظف بنجاح', en: 'User Updated Successfully' },
  'sup.user.fillFields': { ar: 'يرجى ملء جميع الحقول', en: 'Please fill all fields' },
  ...
  'user.tab.schedule': { ar: 'جدول الورديات', en: 'My Tickets' },
  ...
  'user.tab.history': { ar: 'الأرشيف والسجل', en: 'History' },
  'user.tab.history.subtitle': { ar: 'سجل الطلبات السابقة', en: 'Previous requests history' },
  'user.tab.profile': { ar: 'ملفي الشخصي', en: 'My Profile & Stats' },
  ...
  'inv.distribution': { ar: 'توزيع العهد', en: 'Distribute Custody' },
  'inv.custody': { ar: 'عهدتي', en: 'My Custody' },
  'inv.custody.report': { ar: 'تقرير عهد الموظفين', en: 'Staff Custody Report' },
  'inv.dist.staffName': { ar: 'اسم الموظف', en: 'Staff Name' },
  'inv.dist.confirm': { ar: 'تأكيد التوزيع', en: 'Confirm Distribution' },
  'inv.custody.balance': { ar: 'رصيد العهدة', en: 'Custody Balance' },
  'inv.custody.use': { ar: 'استهلاك من العهدة', en: 'Use from Custody' },
  'inv.custody.transfer': { ar: 'نقل عهدة لزميل', en: 'Custody Transfer to Colleague' },
  'inv.custody.confirmReceipt': { ar: 'تأكيد استلام عهدة', en: 'Confirm Custody Receipt' },
  'inv.custody.pendingReceipts': { ar: 'عهود واردة بانتظار التأكيد والعد', en: 'Incoming Custody Pending Confirmation & Verification' },
  'inv.custody.transferor': { ar: 'الموظف المرسِل', en: 'Sender' },
  'inv.custody.confirmBtn': { ar: 'تأكيد استلام العهدة والعدد والكمية', en: 'Confirm Receipt, Count & Quantity' },
  'inv.custody.rejectBtn': { ar: 'رفض الاستلام والعدد', en: 'Reject Receipt' },
  'inv.custody.successConfirm': { ar: 'تم تأكيد استلام العهدة والكمية بنجاح ✅', en: 'Custody receipt and quantity confirmed successfully ✅' },
  'inv.custody.rejected': { ar: 'تم رفض استلام العهدة والطلب', en: 'Custody transfer request rejected' },
  
  'inv.dist.date': { ar: 'تاريخ تسليم العهدة', en: 'Handover Date' },
  'inv.dist.log': { ar: 'سجل توزيع العهد', en: 'Custody Distribution Log' },
  'inv.dist.subtitle': { ar: 'توزيع المخزون الرئيسي إلى الموظفين', en: 'Distribute main stock to employees' },
  'inv.dist.searchPlaceholder': { ar: 'البحث باسم المستلم أو المادة أو الموزع...', en: 'Search by recipient, material, or distributor...' },
  'inv.dist.remainingInStock': { ar: '(المتبقي في المخزن: {qty})', en: '(Remaining in stock: {qty})' },
  'inv.custody.monitor': { ar: 'رصد ومراقبة عهد الموظفين', en: 'Monitor Staff Custody' },
  'inv.custody.monitorDesc': { ar: 'متابعة دقيقة لاستهلاك العهد الموزعة وتمييز الموظفين الذين لم يستهلكوا عهدهم بعد', en: 'Precise tracking of distributed custody usage and identifying employees who haven\'t used their custody yet.' },
  'inv.dist.all': { ar: 'الكل', en: 'All' },
  'inv.custody.notUsed': { ar: 'عهدة لم تُستخدم بعد', en: 'Unused Custody' },
  'inv.custody.partiallyUsed': { ar: 'مستخدمة جزئياً', en: 'Partially Used' },
  'inv.custody.searchPlaceholder': { ar: 'البحث باسم الموظف أو اسم المادة...', en: 'Search by employee or material name...' },
  'inv.custody.custodiesCount': { ar: 'عدد العهد: {count}', en: 'Custody Count: {count}' },
  'inv.custody.unusedWarning': { ar: 'لم تُستخدم بعد ⚠️', en: 'Not used yet ⚠️' },
  'inv.custody.fullyConsumed': { ar: 'مستهلكة بالكامل', en: 'Fully Consumed' },
  'inv.custody.received': { ar: 'المستلم', en: 'Received' },
  'inv.custody.consumed': { ar: 'المستهلك', en: 'Consumed' },
  'inv.custody.remaining': { ar: 'المتبقي', en: 'Remaining' },
  'inv.custody.noStaff': { ar: 'لا يوجد موظفون مسجلون في هذا القسم بعد.', en: 'No registered employees in this department yet.' },
  'inv.custody.handoverLog': { ar: 'سجل تسليم وتنازل العهد (الهاند أوفر) المدمج', en: 'Integrated Custody Handover Log' },
  'inv.custody.handoverLogDesc': { ar: 'ملخص ذكي ومدمج لجميع عمليات نقل وتنازل العهد بين الموظفين دون تكرار المعاملات المتكررة لنفس الزملاء', en: 'Smart and integrated summary of all custody transfer and handover operations between colleagues without repeating logs.' },
  'inv.custody.noHandovers': { ar: 'لا يوجد عمليات نقل عهد مسجلة بعد في هذا القسم', en: 'No custody transfer records in this department yet.' },
  'inv.custody.total': { ar: 'إجمالي', en: 'Total' },
  'inv.custody.units': { ar: 'وحدة', en: 'units' },
  'inv.custody.transferCount': { ar: 'عدد مرات النقل: {count}', en: 'Transfer Count: {count}' },
  'inv.custody.pendingReceipt': { ar: 'بانتظار تأكيد المستلم ⏳', en: 'Pending recipient confirmation ⏳' },
  'inv.custody.rejectedStatus': { ar: 'مرفوضة ❌', en: 'Rejected ❌' },
  'inv.custody.confirmedStatus': { ar: 'تمت بنجاح وتأكيدها ✅', en: 'Confirmed successfully ✅' },
  'inv.custody.individualMovements': { ar: 'تفاصيل الحركات الفردية ({count} حركة)', en: 'Individual movement details ({count} movements)' },
  ...
  'inv.usage.date': { ar: 'التاريخ', en: 'Date' },
  'inv.usage.staffName': { ar: 'اسم الموظف', en: 'Staff Name' },
  ...
  'comm.announcement': { ar: 'تعميم', en: 'Announcement' },
  ...
  'user.dashboard.penalties.title': { ar: 'يوجد جزاءات معلقة تتطلب إجراء', en: 'Pending penalties require action' },
  'user.dashboard.penalty.type': { ar: 'نوع الجزاء:', en: 'Penalty Type:' },
  'user.dashboard.penalty.description': { ar: 'الوصف:', en: 'Description:' },
  'user.dashboard.penalty.reason.placeholder': { ar: 'اكتب سبب الرفض هنا...', en: 'Write the rejection reason here...' },
  'user.dashboard.penalty.reject.confirm': { ar: 'تأكيد الرفض', en: 'Confirm Rejection' },
  'user.dashboard.penalty.cancel': { ar: 'إلغاء', en: 'Cancel' },
  'user.dashboard.penalty.accept': { ar: 'موافقة', en: 'Accept' },
  'user.dashboard.penalty.reject': { ar: 'رفض', en: 'Reject' },
  'user.dashboard.menu.attendance': { ar: 'تسجيل البصمة', en: 'Attendance Punch' },
  'user.dashboard.menu.attendance.subtitle': { ar: 'الحضور والانصراف', en: 'Check In/Out' },
  'user.dashboard.menu.requests': { ar: 'الطلبات', en: 'Requests' },
  'user.dashboard.menu.requests.subtitle': { ar: 'إجازة / تبديل', en: 'Leave / Swap' },
  'user.dashboard.menu.profile.subtitle': { ar: 'ملفي الشخصي', en: 'My Profile' },
  'user.dashboard.menu.performance': { ar: 'أدائي (إحصائيات)', en: 'My Performance (Stats)' },
  'user.dashboard.menu.performance.subtitle': { ar: 'مؤشرات الأداء', en: 'Performance Indicators' },
  'user.dashboard.menu.tasks': { ar: 'المهام', en: 'Tasks' },
  'user.dashboard.menu.tasks.subtitle': { ar: 'إدارة المهام', en: 'Task Management' },
  'user.dashboard.menu.appointments.subtitle': { ar: 'إدارة المواعيد', en: 'Appointment Management' },
  'user.dashboard.toast.geo.unsupported': { ar: 'متصفحك لا يدعم تحديد الموقع', en: 'Your browser does not support geolocation' },
