...
const ALL_PERMISSIONS = [
    ...
    { key: 'handover', label: 'الهاند اوفر والتواصل (Handover)' },
    { key: 'inventory', label: 'المخزون (Inventory)' },
    { key: 'my_custody', label: 'عهدتي (My Custody)' },
    { key: 'custody_distribution', label: 'توزيع العهد (Custody Distribution)' },
    { key: 'catheter_supplies', label: 'مستلزمات القسطرة (Cath-Lab Supplies)' },
    { key: 'radiology_log', label: 'سجل الأشعة المستقل (Radiology Logbook)' },
